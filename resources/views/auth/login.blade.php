...
@section('content')
    ...
    <div class="bg-canvas justify-content-center" style="padding-top: 100px; min-height: 100vh;">
        <h1 class="mt-5 text-center" style="color: #1E555C">Login</h2>
        @if (session('status'))
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="row mx-auto my-3" style="width: 300px;">
                <div class="col-25">
                <label for="email" style="color: #1E555C">Email</label></div>
            ...
            <div class="row mx-auto my-3" style="width: 300px;">
                <div class="col-25">
                <label for="password" style="color: #1E555C">Password</label></div>
